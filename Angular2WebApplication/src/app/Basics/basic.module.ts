...
@NgModule({
    ...
    declarations: [CoursesComponent, HighlightDirective, BindingComponent, InputOutputComponent, ZigZagPipe, PanelComponent, ModelDrivenFormComponent], // Current module components and directives and pipes
    exports: [CoursesComponent, HighlightDirective, BindingComponent, InputOutputComponent, ZigZagPipe, PanelComponent, ModelDrivenFormComponent],  // things to be visible in other modules(Since, we are using all these comps in main app comp, have exported everything)
